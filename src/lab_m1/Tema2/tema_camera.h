...
namespace implementedcamera
{
    ...
    public:
        ...
        void RotateFirstPerson_OX(float angle)
        {
            ...
            glm::vec4 aux = glm::rotate(glm::mat4(1), angle, right) * glm::vec4(forward, 1);
            forward = aux;
        ...
        void RotateFirstPerson_OY(float angle)
        {
            ...
            // vectors!
            glm::vec4 aux = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(forward, 1);
            forward = aux;
            forward = glm::normalize(glm::vec3(forward));

            aux = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 1, 0)) * glm::vec4(right, 1);
            right = aux;
            right = glm::normalize(glm::vec3(right));
        ...
        void RotateFirstPerson_OZ(float angle)
        {
            ...
            glm::vec4 aux = glm::rotate(glm::mat4(1), angle, glm::vec3(0, 0, 1)) * glm::vec4(right, 1);
            right = aux;
            right = glm::normalize(right);

            /*aux = glm::rotate(glm::mat4(1), angle, forward) * glm::vec4(right, 1);
            forward = aux;
            forward = glm::normalize(forward);*/
            up = glm::cross(right, forward);
        }
        ...
        void Follow(glm::vec3 targetPos) {
            position = targetPos - distanceToTarget * glm::normalize(forward);
        }
