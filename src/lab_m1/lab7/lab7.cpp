...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0.938, 0.0097, 0.97));
    }
...
void Lab7::RenderSimpleMesh(Mesh *mesh, Shader *shader, const glm::mat4 & modelMatrix, const glm::vec3 &color)
{
    ...
    int lightLocation = glGetUniformLocation(shader->program, "light_position");
    ...
    int eyeLocation = glGetUniformLocation(shader->program, "eye_position");
    ...
    int shineLocation = glGetUniformLocation(shader->program, "material_shininess");
    glUniform1i(shineLocation, materialShininess);
    ...
    int objectLocation = glGetUniformLocation(shader->program, "object_color");
    glUniform3fv(objectLocation, 1, glm::value_ptr(color));
